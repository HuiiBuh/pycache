...
def test_edge_cases():
    current = datetime.now()
    overflow_minute = datetime(current.year, current.month, current.day, current.hour, 59, current.second)
    time_equals(
    ...
    current = datetime.now()
    overflow_hour = datetime(current.year, current.month, current.day, 23, current.minute, current.second)
    time_equals(
    ...
    current = datetime.now()
    overflow_day = datetime(current.year, current.month, monthrange(current.year, current.month)[1], current.hour,
    ...
    current = datetime.now()
    overflow_month = datetime(current.year, 12, monthrange(current.year, current.month)[1], current.hour,
                              current.minute, current.second)
    time_equals(
